...
public class engineServices extends AppCompatActivity {
    ImageView settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engone_services);
        ...
        tvback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(engineServices.this,autoServices.class);
    ...
    private void retrieveUser() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error != null){
                    Toast.makeText(engineServices.this,error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        });
        rQueue = Volley.newRequestQueue(engineServices.this);
