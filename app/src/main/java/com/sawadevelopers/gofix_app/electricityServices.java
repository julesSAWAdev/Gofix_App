...
public class electricityServices extends AppCompatActivity {
    ImageView settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electricity_services);
        ...
        tvback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(electricityServices.this,autoServices.class);
    ...
    private void retrieveUser() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error != null){
                    Toast.makeText(electricityServices.this,error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        });
        rQueue = Volley.newRequestQueue(electricityServices.this);
