...
public class Electronics {
    ...
    public Electronics(double spare_id,String spare_name,double spare_price,String spare_image,double user_id,String spare_desc,String phone, String address){
