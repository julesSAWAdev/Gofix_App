...
public class SheetServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // retrieveUser();
        ...
        setContentView(R.layout.activity_sheet_services);
        ...
        tvback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(SheetServices.this,autoServices.class);
    ...
    private void retrieveUser() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error != null){
                    Toast.makeText(SheetServices.this,error.toString(), Toast.LENGTH_LONG).show();
                }
            }
        });
        rQueue = Volley.newRequestQueue(SheetServices.this);
